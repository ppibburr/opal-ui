...
if (block == null) block = nil;
        ...
        $opal.defs(self, '$included', function(klass) {
          ...
          return ($opal.defs(self, '$target', TMP_5 = function() {
              ...
              TMP_5._p = null;
              return ($a = ($b = ($scope.Event)._scope.Target).$register, $a._p = block.$to_proc(), $a).call($b);
...
if (selector == null) selector = nil;if (block == null) block = nil;
          if ((($a = element['$=~'](selector)) !== nil && (!$a._isBoolean || $a == true))) {
              new$ = event.$dup();
              new$['$on='](element);
...
(function($opal) {
  ...
  $opal.add_stubs(['$delete', '$join', '$map', '$===', '$new', '$include', '$target', '$supports?', '$[]', '$raise', '$alert', '$prompt', '$confirm']);
  ;
  ;
  ;
  (function($base) {
...
if (value == null) value = nil;
      ...
      if ((($a = $scope.Browser['$supports?']("Window.send")) !== nil && (!$a._isBoolean || $a == true))) {
        ...
        def.$send = function(message, options) {
          ...
          return self.$raise($scope.NotImplementedError, "message sending unsupported");
        }
      };
    ...
    (function($base) {
      ...
      (function($base, $super) {
        ...
        $opal.defs(self, '$[]', function(nodes) {
          ...
          return self.$new(($a = ($b = nodes.$flatten()).$map, $a._p = (TMP_1 = function(x){var self = TMP_1._s || this;
if (x == null) x = nil;
          return self.$DOM($scope.Native.$convert(x))}, TMP_1._s = self, TMP_1), $a).call($b).$uniq());
        });
...
if (el == null) el = nil;
          ...
          if ((($a = result === self.literal) !== nil && (!$a._isBoolean || $a == true))) {
            ...
            return $scope.NodeSet.$new(result)
            } else {
            return result
          };
        };
        ...
        def.$at_css = function(rules) {try {
          ...
          ($a = ($b = self).$each, $a._p = (TMP_4 = function(node){var self = TMP_4._s || this, $a, $b;
if (node == null) node = nil;
          if ((($a = node = ($b = node).$at_css.apply($b, [].concat(rules))) !== nil && (!$a._isBoolean || $a == true))) {
              $opal.$return(node)
              } else {
              return nil
        ...
        def.$at_xpath = function(paths) {try {
          ...
          ($a = ($b = self).$each, $a._p = (TMP_5 = function(node){var self = TMP_5._s || this, $a, $b;
if (node == null) node = nil;
          if ((($a = node = ($b = node).$at_xpath.apply($b, [].concat(paths))) !== nil && (!$a._isBoolean || $a == true))) {
              $opal.$return(node)
              } else {
              return nil
        ...
        def.$css = function(path) {
          ...
          return $scope.NodeSet['$[]'](($a = ($b = self.literal).$map, $a._p = (TMP_6 = function(node){var self = TMP_6._s || this;
if (node == null) node = nil;
          return node.$css(path)}, TMP_6._s = self, TMP_6), $a).call($b));
        };

        def.$filter = function(expression) {
          var $a, $b, TMP_7, self = this;

          return ($a = ($b = self.literal).$select, $a._p = (TMP_7 = function(node){var self = TMP_7._s || this;
if (node == null) node = nil;
          return node['$=~'](expression)}, TMP_7._s = self, TMP_7), $a).call($b);
        };
        ...
        def.$search = function(what) {
          ...
          return $scope.NodeSet['$[]'](($a = ($b = self.literal).$map, $a._p = (TMP_8 = function(node){var self = TMP_8._s || this, $a;
if (node == null) node = nil;
          return ($a = node).$search.apply($a, [].concat(what))}, TMP_8._s = self, TMP_8), $a).call($b));
        };

        return (def.$xpath = function(path) {
          var $a, $b, TMP_9, self = this;

          return $scope.NodeSet['$[]'](($a = ($b = self.literal).$map, $a._p = (TMP_9 = function(node){var self = TMP_9._s || this;
if (node == null) node = nil;
          return node.$xpath(path)}, TMP_9._s = self, TMP_9), $a).call($b));
        }, nil) && 'xpath';
      })(self, null)
...
(function($opal) {
  ...
  $opal.add_stubs(['$include', '$==', '$[]', '$new', '$raise', '$convert', '$native?', '$respond_to?', '$each', '$<<', '$===', '$parent', '$last', '$pop', '$select!', '$=~', '$remove_child', '$remove', '$children', '$supports?', '$node_type', '$first', '$DOM', '$select', '$to_proc', '$element_children', '$to_s', '$next', '$!', '$element?', '$previous', '$try_convert', '$name']);
  return (function($base) {
    var self = $module($base, 'Browser');
    ...
    (function($base) {
      ...
      (function($base, $super) {
        ...
        def['$=='] = function(other) {
          ...
          return self["native"] === $scope.Native.$convert(other);
        };
...
if (n == null) n = nil;
            return self['$<<'](n)}, TMP_2._s = self, TMP_2), $a).call($b)
...
if (p == null) p = nil;
            return p['$=~'](expression)}, TMP_3._s = self, TMP_3), $a).call($b)};
          return $scope.NodeSet.$new(parents);
        };
        ...
        def.$children = function() {
          ...
          return $scope.NodeSet['$[]'](($scope.Native)._scope.Array.$new(self["native"].childNodes));
        };
        ...
        def['$parent='] = function(node) {
          ...
          return self["native"].parentNode = $scope.Native.$convert(node);
        };
        ...
        def.$replace = function(node) {
          ...
          if ((($a = self['$native?'](node)) !== nil && (!$a._isBoolean || $a == true))) {
            ...
            self["native"].parentNode.replaceChild(
        self["native"].ownerDocument.createTextNode(node), self["native"]);
            } else {
            self["native"].parentNode.replaceChild($scope.Native.$convert(node), self["native"]);
          };
          return node;
        };
  ...
  return (function($base) {
    ...
    (function($base) {
      ...
      (function($base, $super) {
        ...
        if ((($a = $scope.Browser['$supports?']("Attr.isId")) !== nil && (!$a._isBoolean || $a == true))) {
    ...
    (function($base) {
      ...
      (function($base, $super) {
        ...
        return (function($base, $super) {
          ...
          if ((($a = ((($b = $scope.Browser['$supports?']("Element.className")) !== false && $b !== nil) ? $b : $scope.Browser['$supports?']("Element.htmlFor"))) !== nil && (!$a._isBoolean || $a == true))) {
            def['$[]'] = function(name, options) {
              ...
              if ((($a = (($b = name['$==']("class")) ? $scope.Browser['$supports?']("Element.className") : $b)) !== nil && (!$a._isBoolean || $a == true))) {
                name = "className"
              } else if ((($a = (($b = name['$==']("for")) ? $scope.Browser['$supports?']("Element.htmlFor") : $b)) !== nil && (!$a._isBoolean || $a == true))) {
                name = "htmlFor"};
              if ((($a = namespace = ((($b = options['$[]']("namespace")) !== false && $b !== nil) ? $b : self.namespace)) !== nil && (!$a._isBoolean || $a == true))) {
          ...
          def.$each = TMP_1 = function() {
            ...
            ($a = ($b = self.element.$attribute_nodes()).$each, $a._p = (TMP_2 = function(attr){var self = TMP_2._s || this, $a;
if (attr == null) attr = nil;
            return $a = $opal.$yieldX(block, [attr.$name(), attr.$value()]), $a === $breaker ? $a : $a}, TMP_2._s = self, TMP_2), $a).call($b);
            return self;
          };
          ...
          def['$merge!'] = function(hash) {
            ...
            ($a = ($b = hash).$each, $a._p = (TMP_3 = function(name, value){var self = TMP_3._s || this;
if (name == null) name = nil;if (value == null) value = nil;
            return self['$[]='](name, value)}, TMP_3._s = self, TMP_3), $a).call($b);
            return self;
          };
...
(function($opal) {
  ...
  $opal.add_stubs(['$attr_reader', '$to_n', '$include', '$enum_for', '$call', '$each', '$=~', '$attributes', '$[]', '$what']);
  return (function($base) {
    var self = $module($base, 'Browser');
    ...
    ;
            ($a = ($b = self.element.$attributes()).$each, $a._p = (TMP_2 = function(name, value){var self = TMP_2._s || this, $a;
if (name == null) name = nil;if (value == null) value = nil;
            if ((($a = name['$=~'](/^data-(.*)$/)) !== nil && (!$a._isBoolean || $a == true))) {
                return block.$call(nil, value)
                } else {
                return nil
              }}, TMP_2._s = self, TMP_2), $a).call($b);
            return self;
          ...
          def.$assign = function(data) {
            ...
            ($a = ($b = data).$each, $a._p = (TMP_3 = function(name, value){var self = TMP_3._s || this;
              if (self["native"] == null) self["native"] = nil;
if (name == null) name = nil;if (value == null) value = nil;
            return self["native"].$data[name] = value;}, TMP_3._s = self, TMP_3), $a).call($b);
            return self;
          };
          ...
          def['$[]'] = function(name) {
            ...
            if ((($a = data = self.element['$[]']("data-" + (self.$what()))) !== nil && (!$a._isBoolean || $a == true))) {
              return data};
        ...
        return (function($base, $super) {
          ...
          if ((($a = $scope.Browser['$supports?']("Element.scroll")) !== nil && (!$a._isBoolean || $a == true))) {
            def.$to = function(args) {
              ...
              args = $slice.call(arguments, 0);
              if ((($a = $scope.Hash['$==='](args.$first())) !== nil && (!$a._isBoolean || $a == true))) {
...
(function($opal) {
  ...
  $opal.add_stubs(['$create_element', '$==', '$capitalize', '$include?', '$constants', '$new', '$const_get', '$include', '$target', '$DOM', '$supports?', '$loaded?', '$raise', '$[]', '$map', '$xpath', '$get', '$attributes', '$set', '$+', '$class_names', '$empty?', '$join', '$uniq', '$first', '$css', '$each', '$alias_native', '$reject', '$to_proc', '$split', '$===', '$assign', '$height', '$size', '$height=', '$to_s', '$clear', '$document', '$<<', '$to_a', '$downcase', '$name', '$id', '$offset', '$flatten', '$concat', '$replace', '$apply', '$to_n', '$window', '$-', '$width', '$width=']);
  ;
  ;
  ;
  ;
  ...
  return (function($base) {
    ...
    (function($base) {
      ...
      (function($base, $super) {
        ...
        var def = self._proto, $scope = self._scope, TMP_1, $a, $b, TMP_2, TMP_6, TMP_8, $c;
        ...
        $opal.defs(self, '$new', TMP_1 = function(node) {var $zuper = $slice.call(arguments, 0);
          ...
          if (self['$==']($scope.Element)) {
            ...
            if ((($a = $scope.Element.$constants()['$include?'](name)) !== nil && (!$a._isBoolean || $a == true))) {
...
if (value == null) value = nil;
        ...
        def['$/'] = function(paths) {
          ...
          paths = $slice.call(arguments, 0);
          return $scope.NodeSet['$[]'](($a = ($b = paths).$map, $a._p = (TMP_3 = function(path){var self = TMP_3._s || this;
if (path == null) path = nil;
          return self.$xpath(path)}, TMP_3._s = self, TMP_3), $a).call($b));
        };
        ...
        def.$at_css = function(rules) {
          ...
          rules = $slice.call(arguments, 0);
          result = nil;
          ($a = ($b = rules).$each, $a._p = (TMP_4 = function(rule){var self = TMP_4._s || this, $a;
if (rule == null) rule = nil;
          if ((($a = result = self.$css(rule).$first()) !== nil && (!$a._isBoolean || $a == true))) {
              return ($breaker.$v = nil, $breaker)
              } else {
              return nil
            }}, TMP_4._s = self, TMP_4), $a).call($b);
        ...
        def.$at_xpath = function(paths) {
          ...
          paths = $slice.call(arguments, 0);
          result = nil;
          ($a = ($b = paths).$each, $a._p = (TMP_5 = function(path){var self = TMP_5._s || this, $a;
if (path == null) path = nil;
          if ((($a = result = self.$xpath(path).$first()) !== nil && (!$a._isBoolean || $a == true))) {
              return ($breaker.$v = nil, $breaker)
              } else {
              return nil
            }}, TMP_5._s = self, TMP_5), $a).call($b);
        ...
        def.$attribute_nodes = function() {
          ...
          return $scope.NodeSet['$[]'](($scope.Native)._scope.Array.$new(self["native"].attributes, $hash2(["get"], {"get": "item"})));
        };
        ...
        if ((($a = $scope.Browser['$supports?']("Query.css")) !== nil && (!$a._isBoolean || $a == true))) {
          def.$css = function(path) {
            ...
            try {
            return $scope.NodeSet['$[]'](($scope.Native)._scope.Array.$new(self["native"].querySelectorAll(path)))
            } catch ($err) {if (true) {
              return $scope.NodeSet['$[]']()
              }else { throw $err; }
            };
          ...
          def.$css = function(path) {
            ...
            try {
            return $scope.NodeSet['$[]'](Sizzle(path, self["native"]))
            } catch ($err) {if (true) {
              return $scope.NodeSet['$[]']()
              }else { throw $err; }
            };
        ...
        def.$data = function(data) {
          var $a, self = this;

          if (data == null) {
            data = nil
          }
          data = $scope.Data.$new(self);
          if (data !== false && data !== nil) {
            } else {
            return data
          };
          if ((($a = $scope.Hash['$==='](data)) !== nil && (!$a._isBoolean || $a == true))) {
            data.$assign(data)
            } else {
            self.$raise($scope.ArgumentError, "unknown data type")
          };
          return self;
        };
    ...
    ;
        ...
        def.$inner_dom = TMP_6 = function() {
          var $a, $b, self = this, $iter = TMP_6._p, block = $iter || nil, doc = nil;

          TMP_6._p = null;
          self.$clear();
          doc = self.$document();
          return self['$<<'](($a = ($b = $scope.Builder).$new, $a._p = block.$to_proc(), $a).call($b, doc, self).$to_a());
        };
        ...
        def.$inspect = function() {
          ...
          if ((($a = self.$id()) !== nil && (!$a._isBoolean || $a == true))) {
            inspect = inspect['$+']("."['$+'](self.$id())['$+']("!"))};
          if ((($a = self.$class_names()['$empty?']()) !== nil && (!$a._isBoolean || $a == true))) {
            } else {
            inspect = inspect['$+']("."['$+'](self.$class_names().$join(".")))
          };
        ...
        def.$search = function(selectors) {
          ...
          return $scope.NodeSet.$new(($a = ($b = selectors).$map, $a._p = (TMP_7 = function(selector){var self = TMP_7._s || this;
if (selector == null) selector = nil;
          return self.$xpath(selector).$to_a().$concat(self.$css(selector).$to_a())}, TMP_7._s = self, TMP_7), $a).call($b).$flatten().$uniq());
        };
        ...
        def.$style = TMP_8 = function(data) {
          var $a, $b, self = this, $iter = TMP_8._p, block = $iter || nil, style = nil;
          ...
          if ((($a = $scope.String['$==='](data)) !== nil && (!$a._isBoolean || $a == true))) {
            style.$replace(data)
          } else if ((($a = $scope.Hash['$==='](data)) !== nil && (!$a._isBoolean || $a == true))) {
            style.$assign(data)
        ...
        if ((($a = ((($c = $scope.Browser['$supports?']("Query.xpath")) !== false && $c !== nil) ? $c : $scope.Browser['$loaded?']("wicked-good-xpath"))) !== nil && (!$a._isBoolean || $a == true))) {
          ...
          return (def.$xpath = function(path) {
            ...
            try {
            return $scope.NodeSet['$[]'](($scope.Native)._scope.Array.$new((self["native"].ownerDocument || self["native"]).evaluate(path,
...
(function($opal) {
  ...
  $opal.add_stubs(['$DOM', '$first', '$css', '$xpath', '$[]', '$inspect', '$children', '$supports?', '$raise', '$ready?', '$call', '$on', '$off', '$convert', '$new']);
  return (function($base) {
    var self = $module($base, 'Browser');
    ...
    (function($base) {
      ...
      (function($base, $super) {
        ...
        var def = self._proto, $scope = self._scope, $a, TMP_1, TMP_3, TMP_5;
    ...
    ;
        ...
        if ((($a = $scope.Browser['$supports?']("Event.addListener")) !== nil && (!$a._isBoolean || $a == true))) {
          def.$ready = TMP_1 = function() {
            ...
            if ((($a = self['$ready?']()) !== nil && (!$a._isBoolean || $a == true))) {
              return block.$call()};
            return ($a = ($b = self).$on, $a._p = (TMP_2 = function(e){var self = TMP_2._s || this;
if (e == null) e = nil;
            e.$off();
              return block.$call();}, TMP_2._s = self, TMP_2), $a).call($b, "dom:load");
          }
        } else if ((($a = $scope.Browser['$supports?']("Event.attach")) !== nil && (!$a._isBoolean || $a == true))) {
          def.$ready = TMP_3 = function() {
            ...
            if ((($a = self['$ready?']()) !== nil && (!$a._isBoolean || $a == true))) {
              return block.$call()};
            return ($a = ($b = self).$on, $a._p = (TMP_4 = function(e){var self = TMP_4._s || this, $a;
if (e == null) e = nil;
            if ((($a = self['$ready?']()) !== nil && (!$a._isBoolean || $a == true))) {
                e.$off();
                return block.$call();
                ...
                return nil
              }}, TMP_4._s = self, TMP_4), $a).call($b, "ready:state:change");
          }
          } else {
          def.$ready = TMP_5 = function() {
            ...
            TMP_5._p = null;
            return self.$raise($scope.NotImplementedError, "document ready unsupported");
          }
        };
        ...
        def.$style_sheets = function() {
          ...
          return ($a = ($b = ($scope.Native)._scope.Array).$new, $a._p = (TMP_6 = function(e){var self = TMP_6._s || this;
if (e == null) e = nil;
          return ($scope.CSS)._scope.StyleSheet.$new(e)}, TMP_6._s = self, TMP_6), $a).call($b, self["native"].styleSheets);
        };
...
(function($opal) {
  ...
  return (function($base) {
    ...
    (function($base) {
      ...
      var def = self._proto, $scope = self._scope, $a, $b, TMP_6, $c, TMP_7, $d, TMP_11;
...
if (klass == null) klass = nil;if (block == null) block = nil;
        ...
        def.$initialize = TMP_4 = function(document) {
          var $a, $b, $c, TMP_5, self = this, $iter = TMP_4._p, block = $iter || nil;

          TMP_4._p = null;
          self.document = document;
          self.builder = ($a = ($b = ($scope.Paggio)._scope.HTML).$new, $a._p = block.$to_proc(), $a).call($b);
          return self.roots = ($a = ($c = self.builder.$each()).$map, $a._p = (TMP_5 = function(e){var self = TMP_5._s || this;
if (e == null) e = nil;
      ...
      ($a = ($b = $scope.Builder).$for, $a._p = (TMP_6 = function(b, item){var self = TMP_6._s || this;
if (b == null) b = nil;if (item == null) item = nil;
      return b.$document().$create_text(item)}, TMP_6._s = self, TMP_6), $a).call($b, $scope.String);

      ($a = ($c = $scope.Builder).$for, $a._p = (TMP_7 = function(b, item){var self = TMP_7._s || this, $a, $b, TMP_8, $c, TMP_9, $d, TMP_10, dom = nil, on = nil, inner = nil;
if (b == null) b = nil;if (item == null) item = nil;
      dom = b.$document().$create_element(item.name);
        ...
        ($a = ($b = (item.class_names)).$each, $a._p = (TMP_8 = function(value){var self = TMP_8._s || this;
if (value == null) value = nil;
        return dom.$add_class(value)}, TMP_8._s = self, TMP_8), $a).call($b);
        if ((($a = on = item.on || nil) !== nil && (!$a._isBoolean || $a == true))) {
          ($a = ($c = on).$each, $a._p = (TMP_9 = function(args, block){var self = TMP_9._s || this, $a, $b;
if (args == null) args = nil;if (block == null) block = nil;
          return ($a = ($b = dom).$on, $a._p = block.$to_proc(), $a).apply($b, [].concat(args))}, TMP_9._s = self, TMP_9), $a).call($c)};
        if ((($a = inner = item.inner_html || nil) !== nil && (!$a._isBoolean || $a == true))) {
          dom['$inner_html='](inner)
          } else {
          ($a = ($d = item).$each, $a._p = (TMP_10 = function(child){var self = TMP_10._s || this;
if (child == null) child = nil;
          return dom['$<<']($scope.Builder.$build(b, child))}, TMP_10._s = self, TMP_10), $a).call($d)
        };
        return dom;}, TMP_7._s = self, TMP_7), $a).call($c, (($scope.Paggio)._scope.HTML)._scope.Element);

      ($a = ($d = $scope.Builder).$for, $a._p = (TMP_11 = function(b, item){var self = TMP_11._s || this;
if (b == null) b = nil;if (item == null) item = nil;
      return item}, TMP_11._s = self, TMP_11), $a).call($d, ($scope.DOM)._scope.Node);
...
(function($opal) {
  ...
  $opal.add_stubs(['$DOM', '$shift', '$to_a', '$new', '$to_proc', '$==', '$length', '$first', '$native?', '$===', '$try_convert', '$raise', '$document']);
  ;
  ;
  ;
  ;
  ...
  (function($base) {
    ...
    def.$DOM = TMP_1 = function(args) {
      var $a, $b, self = this, $iter = TMP_1._p, block = $iter || nil, document = nil, roots = nil, what = nil;
      if ($gvars.document == null) $gvars.document = nil;
      ...
      if (block !== false && block !== nil) {
        ...
        roots = ($a = ($b = (($scope.Browser)._scope.DOM)._scope.Builder).$new, $a._p = block.$to_proc(), $a).call($b, document).$to_a();
        if (roots.$length()['$=='](1)) {
          return roots.$first()
          } else {
          return (($scope.Browser)._scope.DOM)._scope.NodeSet.$new(roots)
        };
        } else {
        what = args.$shift();
        document = ((($a = args.$shift()) !== false && $a !== nil) ? $a : $gvars.document);
...
if (name == null) name = nil;if (value == null) value = nil;
        ...
        def.$apply = TMP_2 = function() {
          ...
          TMP_2._p = null;
          ($a = ($b = ($c = ($d = (($scope.Paggio)._scope.CSS)._scope.Definition).$new, $c._p = block.$to_proc(), $c).call($d)).$each, $a._p = (TMP_3 = function(style){var self = TMP_3._s || this, $a;
            if (self["native"] == null) self["native"] = nil;
if (style == null) style = nil;
